...
os.environ["REPLICATE_API_TOKEN"] = "r8_129dQXIojB0TYWkawLHLY8uyCICvukP1XM9u0"
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_129dQXIojB0TYWkawLHLY8uyCICvukP1XM9u0','Content-Type': 'application/json'}
